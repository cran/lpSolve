...
_static int IsOnList __OF((struct Header *h, unsigned long size));
...
__Fortify_CheckPointer(uptr,OnlyStart,size,file,line)
 void *uptr;
 char OnlyStart;
 unsigned long size;
 char *file;
 unsigned long line;
{
	...
	StartPointer = IsOnList((struct Header *)ptr, size);
...
static int CheckPointer(ptr,size,file,line)
 unsigned char *ptr;
 unsigned long size;
 char *file;
 unsigned long line;
 ...
 */
void *FORTIFY_STORAGE
_Fortify_memcpy(to,from,size,file,line)
 void *from;
 void *to;
 size_t size;
 char *file;
 ...
 */
void *FORTIFY_STORAGE
_Fortify_memmove(to,from,size,file,line)
 void *from;
 void *to;
 size_t size;
 char *file;
 ...
 */
void *FORTIFY_STORAGE
_Fortify_memset(buffer,c,size,file,line)
 void *buffer;
 int c;
 size_t size;
 char *file;
 ...
 */
void *FORTIFY_STORAGE
_Fortify_memchr(buffer,c,size,file,line)
 void *buffer;
 int c;
 size_t size;
 char *file;
 ...
 */
int FORTIFY_STORAGE
_Fortify_memcmp(buffer1,buffer2,size,file,line)
 ...
 */
int FORTIFY_STORAGE
_Fortify_strncmp(buffer1,buffer2,size,file,line)
 ...
 unsigned long line;
{
	...
	__Fortify_CheckPointer(buffer1,0,min(strlen(buffer1),size),file,line);
	__Fortify_CheckPointer(buffer2,0,min(strlen(buffer2),size),file,line);
 ...
 */
char *FORTIFY_STORAGE
_Fortify_strchr(buffer,c,file,line)
 char *buffer;
 int c;
 char *file;
 unsigned long line;
{
	...
	__Fortify_CheckPointer(buffer,0,strlen(buffer),file,line);
...
_Fortify_strlen(buffer,file,line)
 char *buffer;
 char *file;
 unsigned long line;
{
 ...
 */
char *FORTIFY_STORAGE
_Fortify_strcat(buffer1,buffer2,file,line)
 char *buffer1,*buffer2;
 char *file;
 unsigned long line;
{
	...
	__Fortify_CheckPointer(buffer1,0,strlen(buffer2)+1,file,line);
	__Fortify_CheckPointer(buffer2,0,strlen(buffer2),file,line);
 ...
 */
char *FORTIFY_STORAGE
_Fortify_strset(buffer,c,file,line)
 char *buffer;
 int c;
 char *file;
 unsigned long line;
...
__Fortify_strncpy(to,from,size,usesize,file,line)
 char *from;
 char *to;
 size_t size;
 int usesize;
 ...
 unsigned long line;
{
	...
	return(_Fortify_memcpy(to,from,size1,file,line));
}
 ...
 */
char *FORTIFY_STORAGE
_Fortify_strncpy(to,from,size,file,line)
 char *from;
 char *to;
 size_t size;
 char *file;
 ...
 */
char *FORTIFY_STORAGE
_Fortify_strcpy(to,from,file,line)
 char *from;
 char *to;
 char *file;
 unsigned long line;
