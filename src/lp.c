...
/* globals */
char Last_var[NAMELEN], HadConstraint, HadVar;
int Lin_term_count;
REAL f;
int x;
int Sign;
...
void yy_delete_allocated_memory()
{
...
# if defined YY_CURRENT_BUFFER
    /* flex defines the macro YY_CURRENT_BUFFER, so you should only get here if lex.c is
       generated by flex */
    /* lex doesn't defined this macro and thus should not come here, but lex doesn't has
...
static const short yyprhs[] = {     0,
    ...
    79,    81,    84,    88,    89,    91,    94,    97,    99,   102
};

static const short yyrhs[] = {    -1,
    14,    34,    15,    20,     0,    16,     0,    15,    16,     0,
    18,     0,     0,     3,    10,    17,    18,     0,     0,    33,
    ...
    32,     0,     0,    29,     5,    31,    32,     0,     3,     0,
     4,     3,     0,     4,     6,     3,     0,     0,    25,     0,
    12,    35,     0,    11,    35,     0,    35,     0,    29,     8,
     0,     8,     0
};
...
static const short yyrline[] = { 0,
    56,    68,    72,    73,    77,    78,    85,    88,    95,   120,
   121,   124,   125,   128,   131,   134,   135,   136,   139,   140,
   145,   145,   151,   153,   154,   164,   165,   170,   170,   176,
   178,   193,   205,   220,   221,   224,   228,   232,   235,   245
};
#endif
...
"@5","x_lineair_term","lineair_sum","@6","@7","lineair_term","xx_lineair_sum",
"objective_function","real_of", NULL
};
#endif
...
static const short yydefact[] = {     1,
     0,    31,     0,    27,    40,     0,     0,     0,    26,    34,
    38,    32,     0,     0,    37,    36,    29,    39,    31,    25,
    20,    10,     3,     5,    35,    19,    24,     0,    33,    28,
     0,     6,     0,    31,     4,     2,    11,    12,     0,    22,
     8,    30,    34,    21,    15,    13,    16,     0,     0,     0,
     7,    17,    14,     0,    23,     0,    18,     9,     0,     0,
     0
};

static const short yydefgoto[] = {    59,
     1,    22,    23,    43,    24,    50,    36,    37,    38,    39,
    48,    25,    33,    49,    26,     8,    14,    31,    27,    28,
    10,    11
};

static const short yypact[] = {-32768,
     4,-32768,    29,-32768,-32768,    18,    18,    28,-32768,    38,
-32768,-32768,     1,    21,-32768,-32768,-32768,-32768,    -8,    29,
-32768,    24,-32768,-32768,     6,-32768,-32768,    27,-32768,-32768,
    21,-32768,    35,     0,-32768,-32768,    15,-32768,    44,-32768,
-32768,-32768,    41,-32768,-32768,-32768,-32768,    11,    35,    41,
-32768,-32768,-32768,    47,-32768,    32,-32768,-32768,    51,    52,
-32768
};

static const short yypgoto[] = {-32768,
-32768,-32768,    31,-32768,    12,-32768,-32768,-32768,    17,-32768,
-32768,     7,-32768,-32768,   -32,-32768,-32768,-32768,    -1,-32768,
-32768,    42
};
...
static const short yytable[] = {     9,
    44,    32,   -15,    29,     9,     9,     2,     3,     4,    32,
    40,     5,    30,    52,     6,     7,    55,    45,    53,    54,
     2,     3,     4,     2,     3,     5,    34,    20,    21,    42,
   -34,    12,    17,    41,    13,    18,    40,     2,    20,    58,
    19,    20,    21,     2,    20,    21,    47,    15,    16,    57,
    60,    61,    35,    46,    51,     0,    56
};

static const short yycheck[] = {     1,
    33,    10,     3,     3,     6,     7,     3,     4,     5,    10,
     5,     8,    14,     3,    11,    12,    49,     3,     8,     9,
     3,     4,     5,     3,     4,     8,     3,     4,     5,    31,
     7,     3,     5,     7,     6,     8,     5,     3,     4,     8,
     3,     4,     5,     3,     4,     5,     3,     6,     7,     3,
     0,     0,    22,    37,    43,    -1,    50
};
...
#line 96 "lp.y"
{
  if(/* Lin_term_count == 0 */ HadConstraint && !HadVar ) {
    /* it is a range */
    /* already handled */
  }
  else if(/* Lin_term_count == 1 */ !HadConstraint && HadVar) {
    /* it is a bound */
